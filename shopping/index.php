...
<html lang="en">
	<head>
		<!-- Meta -->
		<meta chaRMet="utf-8">
		<meta http-equiv="Content-Type" content="text/html; chaRMet=UTF-8">
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">Scarf</a></li>
					<li><a href="#books" data-toggle="tab">Shawl</a></li>
					<li><a href="#furniture" data-toggle="tab">Inner Neck</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					...
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Add to 
